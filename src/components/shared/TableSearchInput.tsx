...
export default function TableSearchInput<TData>({
  ...
  return (
    <Field className="w-150 ml-auto">
      <InputGroup className="focus-within:border-primary focus-within:ring-0 focus-within:outline-none bg-white placeholder:text-lg  h-15 ">
        <InputGroupInput
          value={searchValue}
          onChange={
        ...
        <InputGroupAddon align="inline-end">
          <Select onValueChange={handleColumnChange}>
            <SelectTrigger className="w-full h-15 text-sm border-none bg-none">
              <SelectValue placeholder="Search By " className="bg-none" />
            </SelectTrigger>
